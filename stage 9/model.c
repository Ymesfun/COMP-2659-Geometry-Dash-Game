...
void initialize_player_gameobj(GameObject *Object, int x, int y, int Speed){
    ...
    void initialize_player_obj(Player *PlayerObj, int x, int y, int Speed){
        ...
        PlayerObj->player_state = STATE_START;
    }
...
void player_death(Player *player){
    ...
    player->alive = false; 
    player->deathcount += 1;
    player->player_state = STATE_DEAD;
...
void player_idle(Player *player){
    ...
    */
    player->player_state = STATE_IDLE;
    player->entity.dx = 0;
    player->entity.dy = 0;
...
/* a function that when collided with would trigger end game state */
    player->entity.dx = 0;
    player->entity.dy = 0;
    player->player_state = WIN_COLLISION;
    player->player_state = STATE_WINNER;
    player->goal = true;
}
